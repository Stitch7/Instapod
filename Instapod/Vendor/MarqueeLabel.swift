...
//        if let presentationLayer = sublabel.layer.presentation() as? CALayer {
...
//            gradientMask.locations = [0.0, NSNumber(leftFadeStop), (1.0 - rightFadeStop), 1.0]
//        }
//
//        // Set up colors
...
//        let mask = maskLayer?.presentation() as? CAGradientLayer
...
//    }
//
//    override open func drawLayer(_ layer: CALayer, inContext ctx: CGContext) {
